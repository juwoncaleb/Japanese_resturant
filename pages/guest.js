        ...
        <div>
            ...
            <div>
                <div className='mt-24 mb-10 flex justify-center  '>
                    <img className=' chinesse mr-10' src='./chii.webp' />
                    <img className='eyes' src='./fem_eyes.webp' />
                    <img className='chinesse ml-10' src='./fib.webp' />
                </div>
                <div className='mt-14 flex justify-center'>
                    ...
                    <div className='story_main_text'>
                        ...
                        <p className='mt-4'>For your convenience, please read the rules before you visit THE CULT Restaurant. If you have any questions, feel free to email us and we'll be happy to help!</p>
                ...
                <div className='mt-10'>
                    <div className='guest_card_two'>
                        <div className='guest_card_text'>
                            ...
                            <p>Every day our restaurant is filled with dozens of people, book a table in two clicks and we'll find the perfect spot: in silence by a panoramic window, closer to a movie projector with iconic anime or overlooking the stunning open kitchen.
                            </p>
                        </div>
                    </div>
                ...
                <div className='card_div'>
                    <div className='card_texts flex justify-center'>
                        ...
                        <div className='second_page_text ml-20'>
                ...
                <div className='card_div2'>
                    <div className='card_texts_2 flex justify-center'>
                        ...
                        <center className='second_page_text mt-10 '>
